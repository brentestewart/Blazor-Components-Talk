...
/// </summary>
public record DeckTheme(string Name, bool IsDark, string Accent);

/// <summary>The built-in presets the deck cycles through (dark first, then light).</summary>
public static class DeckThemes
{
    public static DeckTheme DarkIndigo { get; } = new("Dark · Indigo", true, "#7c8cff");
    public static DeckTheme DarkAmber { get; } = new("Dark · Amber", true, "#f5a623");
    public static DeckTheme LightIndigo { get; } = new("Light · Indigo", false, "#4f5bd5");
    public static DeckTheme LightAmber { get; } = new("Light · Amber", false, "#b26a00");
